...
//			theCase = new GeneralCase();
			...
			Link moveToFocal = getButtonLink("Move to Focal");
			moveToFocal.setStyleClass("buttonHome");
			//moveToFocal.addParameter(PARAMETER_ACTION_REACTIVATE, Boolean.TRUE.toString());
			//moveToFocal.addParameter(PARAMETER_CASE_PK, theCase.getPrimaryKey().toString());
			//moveToFocal.maintainParameter(iwc.getParameter(getCasesBusiness(iwc).getSelectedCaseParameter()), iwc);
			bottom.add(moveToFocal);
